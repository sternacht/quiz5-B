...
static void cleanup_ptr(domain_t *dom, wconfig_t *wconfig, uintptr_t ptr, int flags)
{
 ...
 */
void swap(domain_t *dom, wconfig_t *wconfig, uintptr_t *prot_ptr, uintptr_t new_val, int flags)
{
